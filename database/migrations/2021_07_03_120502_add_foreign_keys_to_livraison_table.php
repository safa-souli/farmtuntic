...
class AddForeignKeysToLivraisonTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('agriculteur_id', 'livraison_agriculteur')->references('id')->on('agriculteur')->onUpdate('CASCADE')->onDelete('CASCADE');
	...
	public function down()
	{
		Schema::table('livraison', function(Blueprint $table)
		{
			$table->dropForeign('livraison_agriculteur');
