                  ...
                  <div class="restaurent-product-list">
                    <div class="restaurent-product-detail">
                      <div class="restaurent-product-left">
                        ...
                        <div class="restaurent-tags-price">
                          ...
                          @inject('note', 'App\Http\Controllers\PanierController')
                            ...
                            <a href="{{ route('product.edit', ['produit' => $produit]) }}" class="btn-first white-btn"><i class="fa fa-edit"></i> </a>
                            <a href="{{ route('product.delete', ['produit' => $produit]) }}" class="btn-first white-btn" onclick="return confirm('Voulez-vous sûr de supprimer?')"><i class="fa fa-trash"></i></a>
                          </div>
                      ...
                      <div class="restaurent-product-img">
                        <img src='{{ URL::asset("storage/assets/img/dish/$produit->image")}}' class="img-fluid" alt="{{ $produit->nom }}">
                      </div>
                    </div>
                  </div>
                </div>
