                    ...
                    <tbody>
                        @foreach ($produits as $key => $produit)
                            <tr>
                                ...
                                <td>{{$produit->nom}} </td>
                                <td>{{$produit->prix}} </td>
                                <td>{{ $time->inWords(new dateTime($produit->created_at)) }}</td>
                                <td>
                                  <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                      <a href="{{ route('product.show', $produit->id)}}" class="dropdown-item">Afficher</a>
                                      <a  href="{{ route('product.edit', $produit->id)}}" class="dropdown-item">Modifier</a>
                                      <a  href="{{ route('product.delete', $produit->id) }}" class="dropdown-item" onclick="return confirm('Voulez-vous sûr du supprimer ce produit?')">Supprimer </a>
                                    </div>
                                </td>
                            </tr>
                        </a>
