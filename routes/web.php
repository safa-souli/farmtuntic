...
Route::get('transport/edit/{transport}', 'transportController@edit')->name('transport.edit');
Route::post('transport//edit/{transport}', 'transportController@update')->name('transport.update');
Route::get('transport//delete/{transport}', 'transportController@delete')->name('transport.delete');
